...
import com.bridgelabz.BookStoreBackend.services.IBookService;
...
//    }
    ...
    public ResponseEntity<ResponseDTO> changePrice(@PathVariable("token") String token, @RequestParam(name = "book_id") Long book_id, @RequestParam Float price) {
        ...
        return new ResponseEntity<ResponseDTO>(new ResponseDTO("price has been changed :", bookService.getBookById(book_id)),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> changeQuantity(@PathVariable("token") String token, @RequestParam(name = "book_id") Long book_id, @RequestParam Long quantity) {
        ...
        return new ResponseEntity<ResponseDTO>(new ResponseDTO("quantity has been changed:", bookService.getBookById(book_id)),
                HttpStatus.OK);
    }
