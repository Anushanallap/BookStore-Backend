...
import com.bridgelabz.BookStoreBackend.exception.UserRegisteredException;
import com.bridgelabz.BookStoreBackend.model.User;
import com.bridgelabz.BookStoreBackend.repo.UserRepository;
...
public class UserService implements IUserService{
    ...
    public Response forgotPassword(String token, String psw) {
        ...
        userRepo.save(user);
        return new Response(200, "password updated succsessfully", user);
    }
